...
pub mod tests {
    ...
    fn test_get_txn_cost() {
        ...
        assert_eq!(get_action_price(crate::utils::constants::CREATE_SCHEMA_ACTION, None).unwrap(), 2);
        assert_eq!(get_action_price(crate::utils::constants::CREATE_CRED_DEF_ACTION, None).unwrap(), 42);
    ...
    fn test_pay_for_txn() {
        ...
        // Schema
        let create_schema_req = crate::utils::constants::SCHEMA_CREATE_JSON.to_string();
        let (_payment, response) = send_transaction(&create_schema_req, crate::utils::constants::CREATE_SCHEMA_ACTION).unwrap();
    ...
    fn test_pay_for_txn_real() {
        ...
        let (_, schema_json) = crate::utils::libindy::anoncreds::tests::create_schema(crate::utils::constants::DEFAULT_SCHEMA_ATTRS);
        let create_schema_req = crate::utils::libindy::anoncreds::tests::create_schema_req(&schema_json);
        let start_wallet = get_wallet_token_info().unwrap();

        let (payment, _response) = send_transaction(&create_schema_req, crate::utils::constants::CREATE_SCHEMA_ACTION).unwrap();
    ...
    fn test_pay_for_txn_fails_with_insufficient_tokens_in_wallet() {
        ...
        let rc = send_transaction(&create_schema_req, crate::utils::constants::CREATE_SCHEMA_ACTION);
    ...
    fn test_submit_fees_with_insufficient_tokens_on_ledger() {
        ...
        let (_, schema_json) = crate::utils::libindy::anoncreds::tests::create_schema(crate::utils::constants::DEFAULT_SCHEMA_ATTRS);
        let req = crate::utils::libindy::anoncreds::tests::create_schema_req(&schema_json);
    ...
    fn test_pay_for_txn_with_empty_outputs_success() {
        ...
        let cost = get_action_price(crate::utils::constants::CREATE_SCHEMA_ACTION, None).unwrap();
        let start_wallet = get_wallet_token_info().unwrap();
    ...
    fn test_empty_fees() {
        ...
        let fees = get_ledger_fees().unwrap();
        println!("fees: {}", fees);
        crate::utils::libindy::anoncreds::tests::create_and_write_test_schema(crate::utils::constants::DEFAULT_SCHEMA_ATTRS);
    }
