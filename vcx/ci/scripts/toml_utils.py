...
def valid_line(line):
    return ('version =' in line or 'version=' in line) and ('uuid' not in line and 'rusqlite' not in line and 'indy' not in line and 'indy' not in line and 'indy-sys' not in line and 'rust' not in line)
