...
use crate::aries::messages::error::{ProblemReport, ProblemReportCodes, Reason};
...
pub mod test {
    ...
    use crate::aries::messages::proof_presentation::presentation_proposal::tests::{_presentation_proposal, _presentation_preview};
