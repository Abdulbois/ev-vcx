use crate::agent::messages::{A2AMessage, A2AMessageV2, A2AMessageKinds, parse_message_from_response, prepare_message_for_agent_v2};
...
mod tests {
    use crate::settings;
    use crate::agent::wallet_backup_restore;
