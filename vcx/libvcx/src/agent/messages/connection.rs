...
use crate::agent::messages::message_type::{MessageTypes, MessageTypeV1, MessageTypeV2};
...
use crate::agent::messages::{A2AMessage, A2AMessageV1, A2AMessageV2, MessageDetail, parse_response_from_agency, A2AMessageKinds, RemoteMessageType, CreateMessage, MessageStatusCode, prepare_message_for_agent, GeneralMessage};
...
impl GeneralMessage for SendInviteBuilder {
    ...
    fn prepare_request(&mut self) -> VcxResult<Vec<u8>> {
        ...
        trace!("SendInvite::prepare_request >>> agent: {:?}", secret!(messages));
...
impl GeneralMessage for AcceptInviteBuilder {
    ...
    fn prepare_request(&mut self) -> VcxResult<Vec<u8>> {
        ...
        trace!("AcceptInvite::prepare_request >>> agent: {:?}", secret!(messages));
...
impl GeneralMessage for RedirectConnectionBuilder {
    ...
    fn prepare_request(&mut self) -> VcxResult<Vec<u8>> {
        ...
        trace!("RedirectConnection::prepare_request >>> agent: {:?}", secret!(messages));
...
pub struct Payload {
    #[serde(rename = "@type")]
    msg_type: crate::agent::messages::payload::PayloadTypes,
    #[serde(rename = "@msg")]
    pub msg: Vec<i8>,
}
