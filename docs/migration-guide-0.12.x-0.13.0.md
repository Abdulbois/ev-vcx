...
* Proof Request
   ...
   * **NEW Message example**
        ...
        > Use `vcx_extract_attached_message` function to get requested attributes and predicates (`proof_request_data`) from proof request message.
